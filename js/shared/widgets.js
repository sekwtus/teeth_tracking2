...
if ($("#UsersDoughnutChart2").length) {
    var doughnutChartCanvas = $("#UsersDoughnutChart2").get(0).getContext("2d");
    var doughnutPieData = {
        datasets: [{
            data: [5, 34, 89],
            backgroundColor: [
...
if ($("#UsersDoughnutChart3").length) {
    var doughnutChartCanvas = $("#UsersDoughnutChart3").get(0).getContext("2d");
    var doughnutPieData = {
        datasets: [{
            data: [80, 54, 25],
            backgroundColor: [
...
if ($("#UsersDoughnutChart4").length) {
    var doughnutChartCanvas = $("#UsersDoughnutChart4").get(0).getContext("2d");
    var doughnutPieData = {
        datasets: [{
            data: [10, 5, 100],
            backgroundColor: [
    ...
    var doughnutChart = new Chart(doughnutChartCanvas, {
        ...
        if ($('#conversionBarChart').length) {
            ...
            var barChart = new Chart(barChartCanvas, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Amount Due',
                        data: [ 211, 116, 311, 319, 121, 181, 331, 124],
                        backgroundColor: primaryColor
                    }]
                },
                options: {
        ...
        if ($('#topSellingProducts1').length) {
            var topSellingChartCanvas = $("#topSellingProducts1").get(0).getContext("2d");

            var topSellingChart = new Chart(topSellingChartCanvas, {
                type: 'line',
                data: {
                    labels: ["PFM", "ZIRCRONAI", "FMC", "EMAX"],
                    datasets: [{
                        label: 'กทม.',
                        data: [150, 200, 150, 220, 350, 275, 365],
                        borderColor: primaryColor,
                        // backgroundColor: '#58d8a373',
                        borderWidth: 2,
                        fill: true
                    },{
                        label: 'พัทยา',
                        data: [95, 52, 45, 78, 21, 54, 85],
                        borderColor: primaryColor,
                        // backgroundColor: '#ff00475c',
                        borderWidth: 2,
                        fill: true
                    }, {
                        label: 'หาดใหญ่',
                        data: [500, 422, 67, 11, 2, 45, 8],
                        borderColor: successColor,
                        // backgroundColor: '#001fff6b',
                        borderWidth: 2,
                        fill: true
                    },]
                },
        ...
        if ($('#topSellingProducts2').length) {
            var topSellingChartCanvas = $("#topSellingProducts2").get(0).getContext("2d");
        ...
        if ($('#topSellingProducts3').length) {
            var topSellingChartCanvas = $("#topSellingProducts3").get(0).getContext("2d");
