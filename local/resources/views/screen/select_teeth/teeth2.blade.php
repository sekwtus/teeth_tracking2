            ...
            <div class="card">
                <div class="card-body">
                    <div class="row border-bottom">
                     ...
                     {{ Form::open(['method' => 'post' , 'url' => '/mainscreen/teeth/addgroup']) }}
                    <div class="row mt-3">
                        ...
                        <div class="card-body">
                            <table  class="table table-striped table-bordered">
                                ...
                                @foreach($teeth as $out_teeth)
                                    {{ Form::open(['method' => 'post' , 'url' => '/mainscreen/teeth/group/'.$out_teeth->ID.'/delete/'.$id]) }}
                                        <tbody>
                                            <tr>
                    ...
                    <div class="row mt-2">
                        <div class="col-sm-12 text-right">
                            <a href="{{ url('/mainscreen/teeth/'.$id) }}">
                                <button type="button" class="btn btn-lg btn-success">
                                    <i class="mdi mdi-arrow-left-bold"></i>ย้อนกลับ
                                </button>
                            </a>
                            {{-- @if($x == '' && $y != '') --}}
                                <a href="{{ url('/mainscreen/Enclosed/'.$id) }}">
