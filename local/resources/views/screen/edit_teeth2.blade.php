            ...
            <div class="card">
                <div class="card-body">
                    <div class="row border-bottom">
                     ...
                     {{ Form::open(['method' => 'post' , 'url' => '/mainscreen/edit_teeth2/addgroup']) }}
                    <div class="row mt-3">
                        <div class="col-md-12 step-content">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                                    <li class="breadcrumb-item active" aria-current="page">จัดกลุ่มซี่ฟัน <b class="text-danger">*กรุณาเลือกที่ฟันที่ต้องการจัดกลุ่ม (จัดกลุ่มได้เฉพาะซี่ฟันที่เลือกมาจากขั้นตอนที่ 1)</b></li>
                                </ol>
                            </nav>
                            <div class="card">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <table class="tbl-tooth" height="10">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <label class="lbl" id="lbl_green_27" style="margin-left:-80px;margin-top:-5px;">
                                                            <img src="{{ asset('images/tooth3color/12.png') }}" class="img-tooth img-tooth-27" id="img-tooth-27" onclick="check(27)">
                                                        </label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center">
                                                        <label class="lbl" id="lbl_green_18" style="margin-right:-70px;margin-top:-10px;">
                                                            <img src="{{ asset('images/tooth3color/27.png') }}" class="img-tooth img-tooth-18" id="img-tooth-18" onclick="check(18)">
                                                        </label>
                                                    </td>
                                                    <td></td>
                                                    <td></td>
                                                ...
                                                <tr>
                                                    <td class="text-center"><h5>LR (4)</h5></td>
                                                    <td></td>
                                                    <td class="text-center">
                                                    ...
                                                    <td></td>
                                                    <td class="text-center"><h5>LL (3)</h5></td>
                                                </tr>
                                            </table>
                                        </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-header" role="tab" id="orderRequestTypeID">
                                                        <a data-toggle="collapse" href="#TypeofWork" aria-expanded="true" aria-controls="TypeofWork">
                                                            <label style=" font-size:10px;">Type of Group</label>
                                                        </a>
                                                    </div>
                        ...
                        <div class="card-body">
                            <table  class="table table-striped table-bordered">
                                ...
                                @foreach($teeth as $out_teeth)
                                    {{ Form::open(['method' => 'post' , 'url' => '/mainscreen/edit_teeth2/group/'.$out_teeth->ID.'/delete/'.$id]) }}
                                        <tbody>
                                            <tr>
                            ...
                            <div class="row mt-2">
                                <div class="col-sm-12 text-right">
                                    <a href="{{ url('/mainscreen/edit_screen_teeth/'.$id) }}">
                            ...
                            <div class="row mt-2">
                                <div class="col-sm-12 text-right">
                                    ...
                                    <a href="{{ url('/mainscreen/detail/teeth/'.$id) }}">
                                        <button class="btn btn-lg btn-success">
                                            ต่อไป
                                            <i class="mdi mdi-arrow-right-bold"></i>
                                        </button>
