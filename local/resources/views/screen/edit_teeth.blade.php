    ...
    <div class="col-12 grid-margin">
      <div class="card">
        <div class="card-body">
          ...
          {{ Form::open(['method' => 'post' , 'url' => '/mainscreen/edit_teeth/addteeth']) }}
          <div class="row mt-3">
            <div class="col-md-12">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <label class="lbl lbl_green_41" id="lbl_green_41" style="margin-right:2px;">
                                                    <img src="{{ asset('images/tooth3color/44.png') }}" class="img-tooth img-tooth-41" id="img-tooth-41" onclick="check(41)">
                                                </label>
                                            </td>
                                            <td>
            ...
            <div class="card-body">
                <table class="table table-striped table-bordered">
                    ...
                    @endphp
                    @foreach($teeth as $out_teeth)
                    {{ Form::open(['method' => 'post' , 'url' =>  '/mainscreen/edit_teeth/'.$out_teeth->ID.'/delete/'.$id.'/'.$out_teeth->TeethID]) }}
                    <tbody>
                        <tr>
        ...
        <div class="row mt-2">
            <div class="col-sm-12 text-right">
                    <a href={{ url('/mainscreen/edit_teeth2/'.$id) }}>
                ...
                <?php
                // if ($count != 1) {
                //     echo"<a href='/mainscreen/edit_teeth2/$id'>
                //     <button class='btn btn-lg btn-success'>
                //         ต่อไป<i class='mdi mdi-arrow-right-bold'></i>
                //     </button>
                //      </a>";
