...
<div class="container-fluid">
    {{ Form::open(['method'=>'post' , 'url'=>'/mainscreen/edit_screen_teeth/save' , 'id'=>'orderform']) }}
    @php
    $count = 0;
    @endphp
                  ...
                  {{ Form::text('company_name',$out_order->company_name, ['class'=>'form-control form-control-sm','readonly']) }}
                        ...
                        <div class="col-sm-6 col-md-8 pr-md-0">แลปที่ผลิต
                            <select class="form-control form-control-sm" id="FactoryID" name="FactoryID">
                                <option value="{{$out_order->FactoryID}}" selected hidden>{{$out_order->company_name}}
                                </option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg- pr-lg-0">
                        <div class="custom-control custom-radio">
                            <input type="radio" value="{{ $out_processround->ID }}" class="custom-control-input"
                                id="processround{{ $out_processround->ID }}" name="processround" checked>
                            <label class="custom-control-label"
                                for="processround{{ $out_processround->ID }}">{{ $out_processround->production_cycle }}</label>
                        </div>
                    </div>
                    @else
                    <div class="col-md-6 col-lg- pr-lg-0">
                        <div class="custom-control custom-radio">
                            <input type="radio" value="{{ $out_processround->ID }}" class="custom-control-input"
                                id="processround{{ $out_processround->ID }}" name="processround">
                            <label class="custom-control-label"
                                for="processround{{ $out_processround->ID }}">{{ $out_processround->production_cycle }}</label>
                        </div>
                    </div>
...
<td id="td-workid" valign="top">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 pr-lg-0">
                    <div class="custom-control custom-radio">
                        ...
                        <input type="radio" value="new" onchange="BarcodeWork(this.value)" class="custom-control-input"
                            id="rdoWorkNew" name="rdoWork" checked>
                        @else
                        <input type="radio" value="new" onchange="BarcodeWork(this.value)" class="custom-control-input"
                            id="rdoWorkNew" name="rdoWork">
                        @endif
                ...
                <div class="col-md-6 col-lg-4 px-lg-0">
                    <div class="custom-control custom-radio">
                        ...
                        <input type="radio" value="edit" onchange="BarcodeWork(this.value)" class="custom-control-input"
                            id="rdoWorkEdit" name="rdoWork" checked>
                        @else
                        <input type="radio" value="edit" onchange="BarcodeWork(this.value)" class="custom-control-input"
                            id="rdoWorkEdit" name="rdoWork">
                        @endif
                ...
                <div class="col-md-6 col-lg-4 pl-lg-0">
                    <div class="custom-control custom-radio">
                        ...
                        <input type="radio" value="con" onchange="BarcodeWork(this.value)" class="custom-control-input"
                            id="rdoWorkContinue" name="rdoWork" checked>
                        @else
                        <input type="radio" value="con" onchange="BarcodeWork(this.value)" class="custom-control-input"
                            id="rdoWorkContinue" name="rdoWork">
                        @endif
    ...
    <div class="row py-1 div-type-edit" style="display:none;">
        <div class="col-12">ประเภทงานแก้
            ...
            <select name="ddlTypeEdit" id="ddlTypeEdit" class="form-control form-control-sm">
    ...
    <div class="row py-1">
        <div class="col-12">ประเภทงาน
            <div class="row">
                ...
                <div class="col-12">
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="type_Deliver{{ $out_type_Deliver->ID }}"
                            name="type_Deliver" value="{{ $out_type_Deliver->ID }}" checked>
                        <label class="custom-control-label"
                            for="type_Deliver{{ $out_type_Deliver->ID }}">{{ $out_type_Deliver->Name }}</label>&nbsp;&nbsp;&nbsp;
                    </div>
                </div>
                @else
                <div class="col-12">
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="type_Deliver{{ $out_type_Deliver->ID }}"
                            name="type_Deliver" value="{{ $out_type_Deliver->ID }}">
                        <label class="custom-control-label"
                            for="type_Deliver{{ $out_type_Deliver->ID }}">{{ $out_type_Deliver->Name }}</label>&nbsp;&nbsp;&nbsp;
                    </div>
                </div>
    ...
    <tr>
        <td id="td-special-command" valign="top">
            <div class="row mb-1">
                ...
                <div class="col-lg-6 pr-0">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="เท MODEL + เท DIE" class="custom-control-input" name="chkCmd1"
                            id="chkCmd1" onclick="ClearRadioCommand(this.id,'rdoGroupCmd1')" checked>
                        <label class="custom-control-label" for="chkCmd1">เท MODEL + เท DIE</label>
                    </div>
                </div>
                <div class="col-lg-3 px-lg-0">
                    <div class="custom-control custom-radio">
                        <input type="radio" value="ส่งกลับ" class="custom-control-input" name="rdoGroupCmd1"
                            id="rdoBackCmd1" checked>
                ...
                <div class="col-lg-6 pr-0">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="เท MODEL + เท DIE" class="custom-control-input" name="chkCmd1"
                            id="chkCmd1" onclick="ClearRadioCommand(this.id,'rdoGroupCmd1')">
                        <label class="custom-control-label" for="chkCmd1">เท MODEL + เท DIE</label>
                    </div>
                </div>
                <div class="col-lg-3 px-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-6 pr-0">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ดู MOUNTING + DIE" class="custom-control-input" name="chkCmd2"
                            id="chkCmd2" onclick="ClearRadioCommand(this.id,'rdoGroupCmd2')" checked>
                ...
                <div class="col-lg-3 px-lg-0">
                    <div class="custom-control custom-radio">
                        <input type="radio" value="ดูทาง Line" class="custom-control-input" name="rdoGroupCmd2"
                            id="rdoLineCmd2" onclick="ClearRadioCommand(this.id,'rdoGroupCmd2')" checked>
                        <label class="custom-control-label" for="rdoLineCmd2">ดูทาง Line</label>
                    </div>
                </div>
                <div class="col-lg-3 px-lg-0">
                    <div class="custom-control custom-radio">
                        <input type="radio" value="ส่งกลับ" class="custom-control-input" name="rdoGroupCmd2"
                            id="rdoBackCmd2" onclick="ClearRadioCommand(this.id,'rdoGroupCmd2')">
                ...
                <div class="col-lg-3 px-lg-0">
                    <div class="custom-control custom-radio">
                        <input type="radio" value="ดูทาง Line" class="custom-control-input" name="rdoGroupCmd2"
                            id="rdoLineCmd2" onclick="ClearRadioCommand(this.id,'rdoGroupCmd2')">
                        <label class="custom-control-label" for="rdoLineCmd2">ดูทาง Line</label>
                    </div>
                </div>
                <div class="col-lg-3 px-lg-0">
                    <div class="custom-control custom-radio">
                        <input type="radio" value="ส่งกลับ" class="custom-control-input" name="rdoGroupCmd2"
                            id="rdoBackCmd2" onclick="ClearRadioCommand(this.id,'rdoGroupCmd2')" checked>
                        <label class="custom-control-label" for="rdoBackCmd2">ส่งกลับ</label>
                    </div>
                </div>
                @endif
                ...
                <div class="col-lg-6 pr-0">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ดู MOUNTING + DIE" class="custom-control-input" name="chkCmd2"
                            id="chkCmd2" onclick="ClearRadioCommand(this.id,'rdoGroupCmd2')">
                        <label class="custom-control-label" for="chkCmd2">ดู MOUNTING + DIE</label>
                    </div>
                </div>
                <div class="col-lg-3 px-lg-0">
                    <div class="custom-control custom-radio">
                        <input type="radio" value="ดูทาง Line" class="custom-control-input" name="rdoGroupCmd2"
                            id="rdoLineCmd2" onclick="ClearRadioCommand(this.id,'rdoGroupCmd2')" disabled>
                        <label class="custom-control-label" for="rdoLineCmd2">ดูทาง Line</label>
                    </div>
                </div>
                <div class="col-lg-3 px-lg-0">
                    <div class="custom-control custom-radio">
                        <input type="radio" value="ส่งกลับ" class="custom-control-input" name="rdoGroupCmd2"
                            id="rdoBackCmd2" onclick="ClearRadioCommand(this.id,'rdoGroupCmd2')" disabled>
                        <label class="custom-control-label" for="rdoBackCmd2">ส่งกลับ</label>
                    </div>
                </div>
                @endif
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-6 pr-0">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ดูโครง WAX" class="custom-control-input" name="chkCmd3"
                            id="chkCmd3" onclick="ClearRadioCommand(this.id,'rdoGroupCmd3')" checked>
                ...
                <div class="col-lg-3 px-lg-0">
                    <div class="custom-control custom-radio">
                        <input type="radio" value="ดูทาง Line" class="custom-control-input" name="rdoGroupCmd3"
                            id="rdoLineCmd3" checked>
                        <label class="custom-control-label" for="rdoLineCmd3">ดูทาง Line</label>
                    </div>
                </div>
                <div class="col-lg-3 px-lg-0">
                    <div class="custom-control custom-radio">
                        <input type="radio" value="ส่งกลับ" class="custom-control-input" name="rdoGroupCmd3"
                            id="rdoBackCmd3">
                ...
                <div class="col-lg-6 pr-0">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ดูโครง WAX" class="custom-control-input" name="chkCmd3"
                            id="chkCmd3" onclick="ClearRadioCommand(this.id,'rdoGroupCmd3')">
                        <label class="custom-control-label" for="chkCmd3">ดูโครง WAX</label>
                    </div>
                </div>
                <div class="col-lg-3 px-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-6 pr-0">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ดู WAX FULL CONTOUR" class="custom-control-input" name="chkCmd4"
                            id="chkCmd4" onclick="ClearRadioCommand(this.id,'rdoGroupCmd4')" checked>
                ...
                <div class="col-lg-3 px-lg-0">
                    <div class="custom-control custom-radio">
                        <input type="radio" value="ดูทาง Line" class="custom-control-input" name="rdoGroupCmd4"
                            id="rdoLineCmd4" checked>
                        <label class="custom-control-label" for="rdoLineCmd4">ดูทาง Line</label>
                    </div>
                </div>
                <div class="col-lg-3 px-lg-0">
                    <div class="custom-control custom-radio">
                        <input type="radio" value="ส่งกลับ" class="custom-control-input" name="rdoGroupCmd4"
                            id="rdoBackCmd4">
                ...
                <div class="col-lg-6 pr-0">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ดู WAX FULL CONTOUR" class="custom-control-input" name="chkCmd4"
                            id="chkCmd4" onclick="ClearRadioCommand(this.id,'rdoGroupCmd4')">
                        <label class="custom-control-label" for="chkCmd4">ดู WAX FULL CONTOUR</label>
                    </div>
                </div>
                <div class="col-lg-3 px-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-6 pr-0">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ลองโครงโลหะ" class="custom-control-input" name="chkCmd5"
                            id="chkCmd5" onclick="ClearRadioCommand(this.id,'rdoGroupCmd5')" checked>
                        <label class="custom-control-label" for="chkCmd5">ลองโครงโลหะ</label>
                    </div>
                </div>
                <div class="col-lg-3 px-lg-0">
                    <div class="custom-control custom-radio">
                        <input type="radio" value="ส่งกลับ" class="custom-control-input" name="rdoGroupCmd5"
                            id="rdoBackCmd5" checked>
                ...
                <div class="col-lg-6 pr-0">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ลองโครงโลหะ" class="custom-control-input" name="chkCmd5"
                            id="chkCmd5" onclick="ClearRadioCommand(this.id,'rdoGroupCmd5')">
                        <label class="custom-control-label" for="chkCmd5">ลองโครงโลหะ</label>
                    </div>
                </div>
                <div class="col-lg-3 px-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ดู CONTOUR PORCELAIN" class="custom-control-input" name="chkCmd6"
                            id="chkCmd6" onclick="ClearRadioCommand(this.id,'rdoGroupCmd6')" checked>
                ...
                <div class="col-lg-3 px-lg-0">
                    <div class="custom-control custom-radio">
                        <input type="radio" value="ดูทาง Line" class="custom-control-input" name="rdoGroupCmd6"
                            id="rdoLineCmd6" checked>
                        <label class="custom-control-label" for="rdoLineCmd6">ดูทาง Line</label>
                    </div>
                </div>
                <div class="col-lg-3 px-lg-0">
                    <div class="custom-control custom-radio">
                        <input type="radio" value="ส่งกลับ" class="custom-control-input" name="rdoGroupCmd6"
                            id="rdoBackCmd6">
                ...
                <div class="col-lg-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ดู CONTOUR PORCELAIN" class="custom-control-input" name="chkCmd6"
                            id="chkCmd6" onclick="ClearRadioCommand(this.id,'rdoGroupCmd6')">
                        <label class="custom-control-label" for="chkCmd6">ดู CONTOUR PORCELAIN</label>
                    </div>
                </div>
                <div class="col-lg-3 px-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ดูดีไซน์ CADCAM" class="custom-control-input" name="chkCmd14"
                            id="chkCmd14" onclick="ClearRadioCommand(this.id,'rdoGroupCmd14')" checked>
                ...
                <div class="col-lg-3 px-lg-0">
                    <div class="custom-control custom-radio">
                        <input type="radio" value="ดูทาง Line" class="custom-control-input" name="rdoGroupCmd14"
                            id="rdoLineCmd14" checked>
                        <label class="custom-control-label" for="rdoLineCmd14">ดูทาง Line</label>
                    </div>
                </div>
                <div class="col-lg-3 px-lg-0">
                    <div class="custom-control custom-radio">
                        <input type="radio" value="ส่งกลับ" class="custom-control-input" name="rdoGroupCmd14"
                            id="rdoBackCmd14">
                ...
                <div class="col-lg-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ดูดีไซน์ CADCAM" class="custom-control-input" name="chkCmd14"
                            id="chkCmd14" onclick="ClearRadioCommand(this.id,'rdoGroupCmd14')">
                        <label class="custom-control-label" for="chkCmd14">ดูดีไซน์ CADCAM</label>
                    </div>
                </div>
                <div class="col-lg-3 px-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-md-12">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ขอ SPUR ด้วย" class="custom-control-input" name="chkCmd7"
                            id="chkCmd7" checked>
            ...
            <div class="row mb-1">
                ...
                <div class="col-md-12">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ส่งทำงานถอดได้ต่อ" class="custom-control-input" name="chkCmd8"
                            id="chkCmd8" checked>
            ...
            <div class="row mb-1">
                ...
                <div class="col-12">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ทำ PINDEX" class="custom-control-input" name="chkCmd9"
                            id="chkCmd9" checked>
            ...
            <div class="row mb-1">
                ...
                <div class="col-12">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="มีงานแก้ส่งมาทำร่วมด้วย" class="custom-control-input"
                            name="chkCmd10" id="chkCmd10" checked>
            ...
            <div class="row mb-1">
                ...
                <div class="col-12">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ดูดีไซน์ทางไลน์" class="custom-control-input" name="chkCmd13"
                            id="chkCmd13" checked>
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ให้ช่างโทรกลับในขั้นตอน" class="custom-control-input"
                            name="chkCmd11" id="chkCmd11" onclick="CommandText(11)" checked>
                ...
                <div class="col-lg-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ให้ช่างโทรกลับในขั้นตอน" class="custom-control-input"
                            name="chkCmd11" id="chkCmd11" onclick="CommandText(11)">
                        <label class="custom-control-label" for="chkCmd11">ให้ช่างโทรกลับในขั้นตอน</label>
                    </div>
                </div>
                <div class="col-lg-6 pl-lg-0">
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="รายละเอียดเพิ่มเติม" class="custom-control-input" name="chkCmd12"
                            id="chkCmd12" onclick="CommandText(12)" checked>
        ...
        <td id="td-attachment" valign="top">
            <div class="row mb-1">
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="IMPRESSION / TRAY" name="chkAttachment8"
                            class="custom-control-input" id="chkAttachment8" onclick="Attachment(8)" checked>
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="IMPRESSION / TRAY" name="chkAttachment8"
                            class="custom-control-input" id="chkAttachment8" onclick="Attachment(8)">
                        <label class="custom-control-label" for="chkAttachment8">IMPRESSION / TRAY</label>
                    </div>
                </div>
                <div class="col-lg-5 pl-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="WORKING MODEL" name="chkAttachment1" class="custom-control-input"
                            id="chkAttachment1" onclick="Attachment(1)" checked>
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="WORKING MODEL" name="chkAttachment1" class="custom-control-input"
                            id="chkAttachment1" onclick="Attachment(1)">
                        <label class="custom-control-label" for="chkAttachment1">WORKING MODEL</label>
                    </div>
                </div>
                <div class="col-lg-5 pl-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="คู่สบ" name="chkAttachment2" class="custom-control-input"
                            id="chkAttachment2" onclick="Attachment(2)" checked>
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="คู่สบ" name="chkAttachment2" class="custom-control-input"
                            id="chkAttachment2" onclick="Attachment(2)">
                        <label class="custom-control-label" for="chkAttachment2">คู่สบ</label>
                    </div>
                </div>
                <div class="col-lg-5 pl-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="BITE" name="chkAttachment3" class="custom-control-input"
                            id="chkAttachment3" onclick="Attachment(3)" checked>
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="BITE" name="chkAttachment3" class="custom-control-input"
                            id="chkAttachment3" onclick="Attachment(3)">
                        <label class="custom-control-label" for="chkAttachment3">BITE</label>
                    </div>
                </div>
                <div class="col-lg-5 pl-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="DIE" name="chkAttachment4" class="custom-control-input"
                            id="chkAttachment4" onclick="Attachment(4)" checked>
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="DIE" name="chkAttachment4" class="custom-control-input"
                            id="chkAttachment4" onclick="Attachment(4)">
                        <label class="custom-control-label" for="chkAttachment4">DIE</label>
                    </div>
                </div>
                <div class="col-lg-5 pl-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="STUDY MODEL" name="chkAttachment5" class="custom-control-input"
                            id="chkAttachment5" onclick="Attachment(5)" checked>
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="STUDY MODEL" name="chkAttachment5" class="custom-control-input"
                            id="chkAttachment5" onclick="Attachment(5)">
                        <label class="custom-control-label" for="chkAttachment5">STUDY MODEL</label>
                    </div>
                </div>
                <div class="col-lg-5 pl-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ARTICULATOR" name="chkAttachment6" class="custom-control-input"
                            id="chkAttachment6" onclick="Attachment(6)" checked>
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ARTICULATOR" name="chkAttachment6" class="custom-control-input"
                            id="chkAttachment6" onclick="Attachment(6)">
                        <label class="custom-control-label" for="chkAttachment6">ARTICULATOR</label>
                    </div>
                </div>
                <div class="col-lg-5 pl-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ชิ้นงานเก่า" name="chkAttachment9" class="custom-control-input"
                            id="chkAttachment9" onclick="Attachment(9)" checked>
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ชิ้นงานเก่า" name="chkAttachment9" class="custom-control-input"
                            id="chkAttachment9" onclick="Attachment(9)">
                        <label class="custom-control-label" for="chkAttachment9">ชิ้นงานเก่า</label>
                    </div>
                </div>
                <div class="col-lg-5 pl-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="เฉดสีฟัน" name="chkAttachment10" class="custom-control-input"
                            id="chkAttachment10" onclick="Attachment(10)" checked>
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="เฉดสีฟัน" name="chkAttachment10" class="custom-control-input"
                            id="chkAttachment10" onclick="Attachment(10)">
                        <label class="custom-control-label" for="chkAttachment10">เฉดสีฟัน</label>
                    </div>
                </div>
                <div class="col-lg-5 pl-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ฟันปลอม" name="chkAttachment11" class="custom-control-input"
                            id="chkAttachment11" onclick="Attachment(11)" checked>
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ฟันปลอม" name="chkAttachment11" class="custom-control-input"
                            id="chkAttachment11" onclick="Attachment(11)">
                        <label class="custom-control-label" for="chkAttachment11">ฟันปลอม</label>
                    </div>
                </div>
                <div class="col-lg-5 pl-lg-0">
        ...
        <td id="td-attachment-implant" valign="top">
            <div class="row mb-1">
                ...
                <div class="col-lg-7 pr-lg-0">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="IMPRESSION CAP" name="chkAttachmentImp1"
                            class="custom-control-input" id="chkAttachmentImp1" onclick="AttachmentImp(1)" checked>
                ...
                <div class="col-lg-7 pr-lg-0">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="IMPRESSION CAP" name="chkAttachmentImp1"
                            class="custom-control-input" id="chkAttachmentImp1" onclick="AttachmentImp(1)">
                        <label class="custom-control-label" for="chkAttachmentImp1">IMPRESSION CAP</label>
                    </div>
                </div>
                <div class="col-lg-5 pl-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-7 pr-lg-0">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="IMPRESSION COPING" name="chkAttachmentImp2"
                            class="custom-control-input" id="chkAttachmentImp2" onclick="AttachmentImp(2)" checked>
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="IMPRESSION COPING" name="chkAttachmentImp2"
                            class="custom-control-input" id="chkAttachmentImp2" onclick="AttachmentImp(2)">
                        <label class="custom-control-label" for="chkAttachmentImp2">IMPRESSION COPING</label>
                    </div>
                </div>
                <div class="col-lg-5 pl-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="SCREW TRANSFER" name="chkAttachmentImp3"
                            class="custom-control-input" id="chkAttachmentImp3" onclick="AttachmentImp(3)" checked>
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="SCREW TRANSFER" name="chkAttachmentImp3"
                            class="custom-control-input" id="chkAttachmentImp3" onclick="AttachmentImp(3)">
                        <label class="custom-control-label" for="chkAttachmentImp3">SCREW TRANSFER</label>
                    </div>
                </div>
                <div class="col-lg-5 pl-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ANALOG" name="chkAttachmentImp4" class="custom-control-input"
                            id="chkAttachmentImp4" onclick="AttachmentImp(4)" checked>
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ANALOG" name="chkAttachmentImp4" class="custom-control-input"
                            id="chkAttachmentImp4" onclick="AttachmentImp(4)">
                        <label class="custom-control-label" for="chkAttachmentImp4">ANALOG MODEL</label>
                    </div>
                </div>
                <div class="col-lg-5 pl-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="SCREW ABUTMENT" name="chkAttachmentImp5"
                            class="custom-control-input" id="chkAttachmentImp5" onclick="AttachmentImp(5)" checked>
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="SCREW ABUTMENT" name="chkAttachmentImp5"
                            class="custom-control-input" id="chkAttachmentImp5" onclick="AttachmentImp(5)">
                        <label class="custom-control-label" for="chkAttachmentImp5">SCREW ABUTMENT</label>
                    </div>
                </div>
                <div class="col-lg-5 pl-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ABUTMENT" name="chkAttachmentImp6" class="custom-control-input"
                            id="chkAttachmentImp6" onclick="AttachmentImp(6)" checked>
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ABUTMENT" name="chkAttachmentImp6" class="custom-control-input"
                            id="chkAttachmentImp6" onclick="AttachmentImp(6)">
                        <label class="custom-control-label" for="chkAttachmentImp6">ABUTMENT</label>
                    </div>
                </div>
                <div class="col-lg-5 pl-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="SCREW DRIVER" name="chkAttachmentImp7"
                            class="custom-control-input" id="chkAttachmentImp7" onclick="AttachmentImp(7)" checked>
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="SCREW DRIVER" name="chkAttachmentImp7"
                            class="custom-control-input" id="chkAttachmentImp7" onclick="AttachmentImp(7)">
                        <label class="custom-control-label" for="chkAttachmentImp7">SCREW DRIVER</label>
                    </div>
                </div>
                <div class="col-lg-5 pl-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="KEY / GIG" name="chkAttachmentImp8" class="custom-control-input"
                            id="chkAttachmentImp8" onclick="AttachmentImp(8)" checked>
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="KEY / GIG" name="chkAttachmentImp8" class="custom-control-input"
                            id="chkAttachmentImp8" onclick="AttachmentImp(8)">
                        <label class="custom-control-label" for="chkAttachmentImp8">KEY / GIG</label>
                    </div>
                </div>
                <div class="col-lg-5 pl-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="เหงือก" name="chkAttachmentImp9" class="custom-control-input"
                            id="chkAttachmentImp9" onclick="AttachmentImp(9)" checked>
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="เหงือก" name="chkAttachmentImp9" class="custom-control-input"
                            id="chkAttachmentImp9" onclick="AttachmentImp(9)">
                        <label class="custom-control-label" for="chkAttachmentImp9">เหงือก</label>
                    </div>
                </div>
                <div class="col-lg-5 pl-lg-0">
            ...
            <div class="row mb-1">
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="healing" name="chkAttachmentImp10" class="custom-control-input"
                            id="chkAttachmentImp10" onclick="AttachmentImp(10)" checked>
                ...
                <div class="col-lg-7">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="healing" name="chkAttachmentImp10" class="custom-control-input"
                            id="chkAttachmentImp10" onclick="AttachmentImp(10)">
                        <label class="custom-control-label" for="chkAttachmentImp10">healing</label>
                    </div>
                </div>
                <div class="col-lg-5 pl-lg-0">
            ...
            <div id="div-system" class="mb-3">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="col-sm-7">
                            <input type="text" value="{{ $Female_Mesial }}" class="form-control number"
                                id="Female_Mesial" name="Female_Mesial" placeholder="ซี่ฟัน">
                        </div>
                    </div>
                    <div class="col-6">
                        <label class="col-sm-3 col-form-label">Mesial</label>
                        <div class="col-sm-7">
                            <input type="text" value="{{ $Male_Mesial }}" class="form-control number" id="Male_Mesial"
                                name="Male_Mesial" placeholder="ซี่ฟัน">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="col-sm-7">
                            <input type="text" value="{{ $Female_Distal }}" class="form-control number"
                                id="Female_Distal" name="Female_Distal" placeholder="ซี่ฟัน">
                        </div>
                    </div>
                    <div class="col-6">
                        <label class="col-sm-3 col-form-label">Distal</label>
                        <div class="col-sm-7">
                            <input type="text" value="{{ $Male_Distal }}" class="form-control number" id="Male_Distal"
                                name="Male_Distal" placeholder="ซี่ฟัน">
                        </div>
                    </div>
                </div>
            </div>
...
<table id="tbl-3" class="tbl" width="100%" border="1">
    ...
    <tr>
        <td id="td-tooth" valign="top" rowspan="5">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_12" style="margin-top:30px;margin-right:2px;">
                            <img src="{{ asset('images/tooth3color/12.png') }}" class="img-tooth img-tooth-12"
                                id="img-tooth-12" onclick="check(12)">
                        </label>
                    </td>
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_11" style="margin-right:2px;">
                            <img src="{{ asset('images/tooth3color/11.png') }}" class="img-tooth img-tooth-11"
                                id="img-tooth-11" onclick="check(11)">
                        </label>
                    </td>
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_21" style="margin-left:2px;">
                            <img src="{{ asset('images/tooth3color/21.png') }}" class="img-tooth img-tooth-21"
                                id="img-tooth-21" onclick="check(21)">
                        </label>
                    </td>
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_22" style="margin-top:30px;margin-left:2px;">
                            <img src="{{ asset('images/tooth3color/22.png') }}" class="img-tooth img-tooth-22"
                                id="img-tooth-22" onclick="check(22)">
                        </label>
                    </td>
                    <td></td>
                    <td class="text-center">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_13" style="margin-left:55px;margin-top:-50px;">
                            <img src="{{ asset('images/tooth3color/13.png') }}" class="img-tooth img-tooth img-tooth-13"
                                id="img-tooth-13" onclick="check(13)">
                        </label>
                    </td>
                    <td></td>
                    <td></td>
                    ...
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_23" style="margin-right:55px;margin-top:-15px;">
                            <img src="{{ asset('images/tooth3color/23.png') }}" class="img-tooth img-tooth-23"
                                id="img-tooth-23" onclick="check(23)">
                        </label>
                    </td>
                    <td></td>
                </tr>
                <tr>
                    ...
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_14" style="margin-right:-10px; margin-top:-5px;">
                            <img src="{{ asset('images/tooth3color/14.png') }}" class="img-tooth img-tooth-14"
                                id="img-tooth-14" onclick="check(14)">
                        </label>
                    </td>
                    <td></td>
                    <td></td>
                    ...
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_24" style="margin-left:-10px; margin-top:-5px;">
                            <img src="{{ asset('images/tooth3color/24.png') }}" class="img-tooth img-tooth-24"
                                id="img-tooth-24" onclick="check(24)">
                        </label>
                    </td>
                    <td></td>
                </tr>
                <tr>
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_15" style="margin-right:-110px;margin-top:-5px;">
                            <img src="{{ asset('images/tooth3color/15.png') }}" class="img-tooth img-tooth-15"
                                id="img-tooth-15" onclick="check(15)">
                        </label>
                    </td>
                    <td></td>
                    <td></td>
                    ...
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_25" style="margin-left:-110px;margin-top:-5px;">
                            <img src="{{ asset('images/tooth3color/25.png') }}" class="img-tooth img-tooth-25"
                                id="img-tooth-25" onclick="check(25)">
                        </label>
                    </td>
                </tr>
                <tr>
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_16" style="margin-right:-90px;margin-top:-5px;">
                            <img src="{{ asset('images/tooth3color/16.png') }}" class="img-tooth img-tooth-16"
                                id="img-tooth-16" onclick="check(16)">
                        </label>
                    </td>
                    <td></td>
                    <td></td>
                    ...
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_26" style="margin-left:-90px;margin-top:-5px;">
                            <img src="{{ asset('images/tooth3color/26.png') }}" class="img-tooth img-tooth-26"
                                id="img-tooth-26" onclick="check(26)">
                        </label>
                    </td>
                </tr>
                <tr>
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_17" style="margin-right:-80px;margin-top:-5px;">
                            <img src="{{ asset('images/tooth3color/17.png') }}" class="img-tooth img-tooth-17"
                                id="img-tooth-17" onclick="check(17)">
                        </label>
                    </td>
                    <td></td>
                    <td></td>
                    ...
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_27" style="margin-left:-80px;margin-top:-5px;">
                            <img src="{{ asset('images/tooth3color/27.png') }}" class="img-tooth img-tooth-27"
                                id="img-tooth-27" onclick="check(27)">
                        </label>
                    </td>
                </tr>
                <tr>
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_18" style="margin-right:-70px;margin-top:-10px;">
                            <img src="{{ asset('images/tooth3color/18.png') }}" class="img-tooth img-tooth-18"
                                id="img-tooth-18" onclick="check(18)">
                        </label>
                    </td>
                    <td></td>
                    <td></td>
                    ...
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_28" style="margin-left:-70px;margin-top:-10px;">
                            <img src="{{ asset('images/tooth3color/28.png') }}" class="img-tooth img-tooth-28"
                                id="img-tooth-28" onclick="check(28)">
                        </label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_48" style="margin-right:-70px;margin-bottom:0px;">
                            <img src="{{ asset('images/tooth3color/48.png') }}" class="img-tooth img-tooth-48"
                                id="img-tooth-48" onclick="check(48)">
                        </label>
                    </td>
                    <td></td>
                    <td></td>
                    ...
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_38" style="margin-left:-70px;margin-bottom:0px;">
                            <img src="{{ asset('images/tooth3color/38.png') }}" class="img-tooth img-tooth-38"
                                id="img-tooth-38" onclick="check(38)">
                        </label>
                    </td>
                </tr>
                <tr>
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_47" style="margin-right:-80px;margin-bottom:0px;">
                            <img src="{{ asset('images/tooth3color/47.png') }}" class="img-tooth img-tooth-47"
                                id="img-tooth-47" onclick="check(47)">
                        </label>
                    </td>
                    <td></td>
                    <td></td>
                    ...
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_37" style="margin-left:-80px;margin-bottom:0px;">
                            <img src="{{ asset('images/tooth3color/37.png') }}" class="img-tooth img-tooth-37"
                                id="img-tooth-37" onclick="check(37)">
                        </label>
                    </td>
                </tr>
                <tr>
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_46" style="margin-right:-90px;margin-bottom:0px;">
                            <img src="{{ asset('images/tooth3color/46.png') }}" class="img-tooth img-tooth-46"
                                id="img-tooth-46" onclick="check(46)">
                        </label>
                    </td>
                    <td></td>
                    <td></td>
                    ...
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_36" style="margin-left:-90px;margin-bottom:0px;">
                            <img src="{{ asset('images/tooth3color/36.png') }}" class="img-tooth img-tooth-36"
                                id="img-tooth-36" onclick="check(36)">
                        </label>
                    </td>
                </tr>
                <tr>
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_45" style="margin-right:-110px;margin-bottom:-0px;">
                            <img src="{{ asset('images/tooth3color/45.png') }}" class="img-tooth img-tooth-45"
                                id="img-tooth-45" onclick="check(45)">
                        </label>
                    </td>
                    <td></td>
                    <td></td>
                    ...
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_35" style="margin-left:-110px;margin-bottom:-0px;">
                            <img src="{{ asset('images/tooth3color/35.png') }}" class="img-tooth img-tooth-35"
                                id="img-tooth-35" onclick="check(35)">
                        </label>
                    </td>
                </tr>
                <tr>
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_44" style="margin-right:-140px;margin-bottom:-0px;">
                            <img src="{{ asset('images/tooth3color/44.png') }}" class="img-tooth img-tooth-44"
                                id="img-tooth-44" onclick="check(44)">
                        </label>
                    </td>
                    <td></td>
                    <td></td>
                    ...
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_34" style="margin-left:-140px;margin-bottom:-0px;">
                            <img src="{{ asset('images/tooth3color/34.png') }}" class="img-tooth img-tooth-34"
                                id="img-tooth-34" onclick="check(34)">
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_43" style="margin-left:55px;margin-bottom:-0px;">
                            <img src="{{ asset('images/tooth3color/43.png') }}" class="img-tooth img-tooth-43"
                                id="img-tooth-43" onclick="check(43)">
                        </label>
                    </td>
                    <td></td>
                    <td></td>
                    ...
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_33" style="margin-right:55px;margin-bottom:-0px;">
                            <img src="{{ asset('images/tooth3color/33.png') }}" class="img-tooth img-tooth-33"
                                id="img-tooth-33" onclick="check(33)">
                        </label>
                    </td>
                    <td></td>
                </tr>
                <tr>
                    ...
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_42" style="margin-bottom:50px;margin-right:2px;">
                            <img src="{{ asset('images/tooth3color/42.png') }}" class="img-tooth img-tooth-42"
                                id="img-tooth-42" onclick="check(42)">
                        </label>
                    </td>
                    <td class="text-center">
                        <label class="lbl" id="lbl_green_41" style="margin-right:2px;">
                            <img src="{{ asset('images/tooth3color/41.png') }}" class="img-tooth img-tooth-41"
                                id="img-tooth-41" onclick="check(41)">
                        </label>
                    </td>
                    <td>
                        <label class="lbl" id="lbl_green_31" style="margin-left:2px;">
                            <img src="{{ asset('images/tooth3color/31.png') }}" class="img-tooth img-tooth-31"
                                id="img-tooth-31" onclick="check(31)">
                        </label>
                    </td>
                    <td>
                        <label class="lbl" id="lbl_green_32" style="margin-bottom:50px;margin-left:2px;">
                            <img src="{{ asset('images/tooth3color/32.png') }}" class="img-tooth img-tooth-32"
                                id="img-tooth-32" onclick="check(32)">
                        </label>
                    </td>
                    <td></td>
                    <td class="text-center">
            ...
            @for($i = 1; $i <= 4; $i++) @for($j=1; $j <=8; $j++) @php $k=$i*10; $k=$k+$j; @endphp <input type="checkbox"
                id="chkTooth_{{$k}}" name="chkTooth_{{$k}}" value={{$k}}>
                @foreach($teeth as $out_teeth)
    ...
    <tr>
        <td id="td-alloys" valign="top">
            <div id="div-alloys" class="row mb-3" style="display:;">
                <div class="col-12">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="NON_PRECIOUS" class="custom-control-input" id="rdoAlloys1"
                            name="rdoAlloys1" onchange="checkOnlyOne(this.id,this.name)">
                        <label class="custom-control-label" for="rdoAlloys1">NON PRECIOUS</label>
                    </div>
                </div>
                <div class="col-12">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="PALLADIUM" class="custom-control-input" id="rdoAlloys2"
                            name="rdoAlloys2" onchange="checkOnlyOne(this.id,this.name)">
                        <label class="custom-control-label" for="rdoAlloys2">PALLADIUM</label>
                    </div>
                </div>
                <div class="col-12">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="SEMI PRECIOUS" class="custom-control-input" id="rdoAlloys3"
                            name="rdoAlloys3" onchange="checkOnlyOne(this.id,this.name)">
                        <label class="custom-control-label" for="rdoAlloys3">SEMI PRECIOUS</label>
                    </div>
                </div>
                <div class="col-12">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="HIGH PRECIOUS" class="custom-control-input" id="rdoAlloys4"
                            name="rdoAlloys4" onchange="checkOnlyOne(this.id,this.name)">
                        <label class="custom-control-label" for="rdoAlloys4">HIGH PRECIOUS</label>
                    </div>
                </div>
                <div class="col-12">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="แจ้งค่าโลหะก่อนเหวี่ยง" class="custom-control-input"
                            id="rdoAlloys5" name="rdoAlloys5" onchange="checkOnlyOne(this.id,this.name)">
                        <label class="custom-control-label" for="rdoAlloys5">แจ้งค่าโลหะก่อนเหวี่ยง</label>
                    </div>
                </div>
                <div class="col-12">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="มีโลหะมาเคลม" class="custom-control-input" id="rdoAlloys6"
                            name="rdoAlloys6" onchange="checkOnlyOne(this.id,this.name)">
                        <label class="custom-control-label" for="rdoAlloys6">มีโลหะมาเคลม</label>
                    </div>
                </div>
                <div class="col-12">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="รอถามแพทย์" class="custom-control-input" id="rdoAlloys7"
                            name="rdoAlloys7" onchange="checkOnlyOne(this.id,this.name)">
        ...
        <td id="td-shade" valign="top" rowspan="3">
            <div id="div-shade" class="mb-3">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="สีเดียว" class="custom-control-input" id="rdoShadeOneColor"
                                name="rdoGroupShade" onclick="Color(this.value,'Shade',this.id)"
                                onchange="checkOnlyOne(this.id,this.name)">
                            <label class="custom-control-label" for="rdoShadeOneColor">สีเดียว</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="หลายสี" class="custom-control-input" id="rdoShadeMultiColor"
                                name="rdoGroupShade" onclick="Color(this.value,'Shade',this.id)"
                                onchange="checkOnlyOne(this.id,this.name)">
                ...
                <div class="row mt-1">
                    <div class="col-md-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="แพทย์ส่งสีฟันมาทาง Line" class="custom-control-input"
                                id="rdoShadeLine" name="rdoGroupShade2" onchange="checkOnlyOne(this.id,this.name)">
                            <label class="custom-control-label" for="rdoShadeLine">แพทย์ส่งสีฟันมาทาง Line</label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="จะส่งคนไข้มาเทียบสีที่ Lab" class="custom-control-input"
                                id="rdoShadeCompare" name="rdoGroupShade2" onchange="checkOnlyOne(this.id,this.name)">
                            <label class="custom-control-label" for="rdoShadeCompare">จะส่งคนไข้มาเทียบสีที่ Lab</label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="รอถามแพทย์" class="custom-control-input" id="rdoShadeDoctor"
                                name="rdoGroupShade2" onchange="checkOnlyOne(this.id,this.name)">
                ...
                <div id="div-Shade-one" class="mt-3" style="display:none;">
                    ...
                    <div class="row">
                        <div class="col-md-8 mb-1">
                            <select class="form-control form-control-sm" id="Shade-one-brand" name="ddlShadeBrand"
                                onchange="SelectColor(this.value,'ddlShadeColor',this.id)">
                                <option value="0">ยี่ห้อ</option>
                                @foreach ( $screen_SHADE_Brand as $out_screen_SHADE_Brand)
                                <option value="{{ $out_screen_SHADE_Brand->id }}">{{ $out_screen_SHADE_Brand->name }}
                                </option>
                                @endforeach
                ...
                <div id="div-Shade-multi" class="mt-3" style="display:none;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 pl-md-0 mb-1">
                            <select name="ddlShadeBrandMulti1" id="Shade-multi-brand1"
                                class="form-control form-control-sm"
                                onchange="SelectColor(this.value,'ddlShadeColordMulti1',this.id)">
                                <option value="0">ยี่ห้อ</option>
                                @foreach ( $screen_SHADE_Brand as $out_screen_SHADE_Brand)
                                <option value="{{ $out_screen_SHADE_Brand->id }}">{{ $out_screen_SHADE_Brand->name }}
                                </option>
                        ...
                        <div class="col-md-4 pl-md-0">
                            <select name="ddlShadeColordMulti1" id="Shade-multi-color1"
                                class="form-control form-control-sm">
                                <option value="0">สี</option>
                            </select>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 pl-md-0 mb-1">
                            <select name="ddlShadeBrandMulti2" id="Shade-multi-brand2"
                                class="form-control form-control-sm"
                                onchange="SelectColor(this.value,'ddlShadeColordMulti2',this.id)">
                                <option value="0">ยี่ห้อ</option>
                                @foreach ( $screen_SHADE_Brand as $out_screen_SHADE_Brand)
                                <option value="{{ $out_screen_SHADE_Brand->id }}">{{ $out_screen_SHADE_Brand->name }}
                                </option>
                        ...
                        <div class="col-md-4 pl-md-0">
                            <select name="ddlShadeColordMulti2" id="Shade-multi-color2"
                                class="form-control form-control-sm">
                                <option value="0">สี</option>
                            </select>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 pl-md-0 mb-1">
                            <select name="ddlShadeBrandMulti3" id="Shade-multi-brand3"
                                class="form-control form-control-sm"
                                onchange="SelectColor(this.value,'ddlShadeColordMulti3',this.id)">
                                <option value="0">ยี่ห้อ</option>
                                @foreach ( $screen_SHADE_Brand as $out_screen_SHADE_Brand)
                                <option value="{{ $out_screen_SHADE_Brand->id }}">{{ $out_screen_SHADE_Brand->name }}
                                </option>
                        ...
                        <div class="col-md-4 pl-md-0">
                            <select name="ddlShadeColordMulti3" id="Shade-multi-color3"
                                class="form-control form-control-sm">
                                <option value="0">สี</option>
                            </select>
                        </div>
            ...
            <div id="div-stump" class="mb-3">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="สีเดียว" class="custom-control-input" id="rdoStumpOneColor"
                                name="rdoGroupStump" onclick="Color(this.value,'Stump',this.id)"
                                onchange="checkOnlyOne(this.id,this.name)">
                    ...
                    <div class="col-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="แพทย์ส่งสีฟันมาทาง Line" class="custom-control-input"
                                id="rdoStumpLine" name="rdoGroupStump" onclick="Color(this.value,'Stump',this.id)"
                                onchange="checkOnlyOne(this.id,this.name)">
                    ...
                    <div class="col-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="จะส่งคนไข้มาเทียบสีที่ Lab" class="custom-control-input"
                                id="rdoStumpCompare" name="rdoGroupStump" onclick="Color(this.value,'Stump',this.id)"
                                onchange="checkOnlyOne(this.id,this.name)">
                    ...
                    <div class="col-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="รอถามแพทย์" class="custom-control-input" id="rdoStumpDoctor"
                                name="rdoGroupStump" onclick="Color(this.value,'Stump',this.id)"
                                onchange="checkOnlyOne(this.id,this.name)">
                ...
                <div id="div-Stump-one" class="mt-3" style="display:none;">
                    ...
                    <div class="row">
                        <div class="col-md-8 mb-1">
                            <select class="form-control form-control-sm" id="Stump-one-brand" name="ddlStumpBrand"
                                onchange="SelectColor(this.value,'ddlStumpColor',this.id)">
                                <option value="0">ยี่ห้อ</option>
                                @foreach ( $screen_SHADE_Brand as $out_screen_SHADE_Brand)
                                <option value="{{ $out_screen_SHADE_Brand->id }}">{{ $out_screen_SHADE_Brand->name }}
                                </option>
            ...
            <div id="div-occlusal" class="mb-3">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="NONE" class="custom-control-input" id="rdoStaining1"
                                name="rdoStaining" onchange="checkOnlyOne(this.id,this.name)">
                            <label class="custom-control-label" for="rdoStaining1">NONE</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="LIGHT" class="custom-control-input" id="rdoStaining2"
                                name="rdoStaining" onchange="checkOnlyOne(this.id,this.name)">
                    ...
                    <div class="col-md-6">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="MEDIUM" class="custom-control-input" id="rdoStaining3"
                                name="rdoStaining" onchange="checkOnlyOne(this.id,this.name)">
                    ...
                    <div class="col-md-6">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="DARK" class="custom-control-input" id="rdoStaining4"
                                name="rdoStaining" onchange="checkOnlyOne(this.id,this.name)">
                ...
                <div class="row mt-3">
                    <div class="col-md-6 pr-md-1 text-center">
                        ...
                        <label for="MARGIN1" class="pointer text-center">
                            <img class="pontic" data-toggle="tooltip" src="{{ asset('images/mental-design/11.png') }}"
                                title data-original-title="Porcelain Margin">
                    ...
                    <div style="font-size:5px;">Margin</div> --}}
                        ...
                        <label for="MARGIN2" class="pointer text-center">
                            <img class="pontic" data-toggle="tooltip" src="{{ asset('images/mental-design/12.png') }}"
                                title data-original-title="Extended โดยรอบ">
                            {{-- <div style="font-size:5px;">Extended</div>
                    <div style="font-size:5px;">โดยรอบ</div> --}}
                        </label>

                        <input type="checkbox" name="MARGIN1" id="MARGIN3" class="hidden" value="13.png"
                            onchange="checkOnlyOne(this.id,this.name)">
                        <label for="MARGIN3" class="pointer text-center">
                            <img class="pontic" data-toggle="tooltip" src="{{ asset('images/mental-design/13.png') }}"
                                title data-original-title="Extended Margin">
                            {{-- <div style="font-size:5px;">Extended</div>
                     <div style="font-size:5px;">Margin</div> --}}
                        </label>
                        ...
                        <label for="MARGIN4" class="pointer text-center">
                            <img class="pontic" data-toggle="tooltip" src="{{ asset('images/mental-design/14.png') }}"
                                title data-original-title="Matal Margin">
                    ...
                    <div class="col-md-6 pl-md-1">
                        <div class="row">
                            <div class="col-md-6 py-1 pr-md-1">
                                <input type="text" class="form-control form-control-sm" placeholder="Buccal mm."
                                    name="MARGIN_Buccal">
                            </div>
                            <div class="col-md-6 py-1 pl-md-1">
                                <input type="text" class="form-control form-control-sm" placeholder="Lingual mm."
                                    name="MARGIN_Lingual">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        ...
                        <label for="sad4" class="pointer m-1">
                            <img class="pontic" data-toggle="tooltip" src="{{ asset('images/mental-design/21.png') }}"
                                title data-original-title="Porcelain Total Baking">
                            {{-- <div style="font-size:5px;">Porcelain</div>
                      <div style="font-size:5px;">Total Baking</div> --}}
                        </label>
                        <input type="checkbox" name="MARGIN2" id="sad5" class="hidden" value="22.png"
                            onchange="checkOnlyOne(this.id,this.name)">
                        <label for="sad5" class="pointer m-1">
                            <img class="pontic" data-toggle="tooltip" src="{{ asset('images/mental-design/22.png') }}"
                                title data-original-title="Porcelain Extended Margin">
                            {{-- <div style="font-size:5px;">Porcelain</div>
                      <div style="font-size:5px;">Extended Margin</div> --}}
                        ...
                        <label for="sad6" class="pointer m-1">
                            <img class="pontic" data-toggle="tooltip" src="{{ asset('images/mental-design/23.png') }}"
                                title data-original-title="Metal Margin">
                      ...
                      <div style="font-size:5px;">Margin</div> --}}
                        ...
                        <label for="sad7" class="pointer m-1">
                            <img class="pontic" data-toggle="tooltip" src="{{ asset('images/mental-design/24.png') }}"
                                title data-original-title="3/4 Occlusal Metal">
                      ...
                      <div style="font-size:5px;">Metal</div> --}}
                        ...
                        <label for="sad8" class="pointer m-1">
                            <img class="pontic" data-toggle="tooltip" src="{{ asset('images/mental-design/25.png') }}"
                                title data-original-title="Occlusal Metal">
                      ...
                      <div style="font-size:5px;">Metal</div> --}}
                        ...
                        <label for="sad9" class="pointer m-1">
                            <img class="pontic" data-toggle="tooltip" src="{{ asset('images/mental-design/26.png') }}"
                                title data-original-title="3/4 Metal เฉพาะด้านกัด">
                      ...
                      <div style="font-size:5px;">เฉพาะด้านกัด</div> --}}
                        ...
                        <label for="sad10" class="pointer m-1">
                            <img class="pontic" data-toggle="tooltip" src="{{ asset('images/mental-design/27.png') }}"
                                title data-original-title="OCC. Metal เฉพาะด้านกัด">
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        ...
                        <label for="sad11" class="pointer m-1">
                            <img class="pontic" data-toggle="tooltip" src="{{ asset('images/mental-design/31.png') }}"
                                title data-original-title="หมอออกแบบเอง">
                            {{-- <div style="font-size:5px;">หมอออก</div>
                      <div style="font-size:5px;">แบบเอง</div> --}}
                        </label>
                        <input type="checkbox" name="MARGIN3" id="sad12" class="hidden" value="32.png"
                            onchange="checkOnlyOne(this.id,this.name)">
                        <label for="sad12" class="pointer m-1">
                            <img class="pontic" data-toggle="tooltip" src="{{ asset('images/mental-design/32.png') }}"
                                title data-original-title="Lingual Metal Margin">
                        ...
                        <label for="sad13" class="pointer m-1">
                            <img class="pontic" data-toggle="tooltip" src="{{ asset('images/mental-design/33.png') }}"
                                title data-original-title="1/3 Lingual Metal Margin">
                        ...
                        <label for="sad14" class="pointer m-1">
                            <img class="pontic" data-toggle="tooltip" src="{{ asset('images/mental-design/34.png') }}"
                                title data-original-title="3/4 Lingual Metal Margin">
                        ...
                        <label for="sad15" class="pointer m-1">
                            <img class="pontic" data-toggle="tooltip" src="{{ asset('images/mental-design/35.png') }}"
                                title data-original-title="Lingual Metal">
                            {{-- <div style="font-size:5px;">Lingual</div>
                      <div style="font-size:5px;">Metal</div> --}}
                        </label>
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-12 text-center">
                        ...
                        <label for="PONTIC1" class="pointer m-2">
                            <img class="pontic" src="{{ asset('images/pontic-design/1.png') }}" title
                                data-original-title="Bullet Type Pontic">
                      ...
                      <div style="font-size:5px;">Type Pontic</div> --}}
                        ...
                        <label for="PONTIC2" class="pointer m-2">
                            <img class="pontic" src="{{ asset('images/pontic-design/2.png') }}" title
                                data-original-title="Hygienic Pontic/Conical Pontic">
                            {{-- <div style="font-size:5px;">Hygienic Pontic</div>
                        <div style="font-size:5px;">/Conical Pontic</div> --}}
                        </label>

                        <input class="hidden" type="checkbox" name="PONTIC_DESIGN" id="PONTIC4" value="3.png"
                            onchange="checkOnlyOne(this.id,this.name)">
                        <label for="PONTIC4" class="pointer m-2">
                            <img class="pontic" src="{{ asset('images/pontic-design/3.png') }}" title
                                data-original-title="Modified Ridge Lab Pontic">
                        ...
                        <label for="PONTIC6" class="pointer m-2">
                            <img class="pontic" src="{{ asset('images/pontic-design/5.png') }}" title
                                data-original-title="Oval Pontic">
        ...
        <td id="td-contour" valign="top">
            <div id="div-gingival" class="mb-3">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="เปิด" class="custom-control-input" id="chkOpenGingival"
                                name="chkGingival" onchange="checkOnlyOne(this.id,this.name)">
                            <label class="custom-control-label" for="chkOpenGingival">เปิด</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="ปิด" class="custom-control-input" id="chkCloseGingival"
                                name="chkGingival" onchange="checkOnlyOne(this.id,this.name)">
            ...
            <div id="div-occlusion" class="mb-3">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="สบสนิท" class="custom-control-input" id="chkOcclusion1"
                                name="chkOcclusion" onchange="checkOnlyOne(this.id,this.name)">
                            <label class="custom-control-label" for="chkOcclusion1">สบสนิท</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="UNDER" class="custom-control-input" id="chkOcclusion2"
                                name="chkOcclusion" onchange="checkOnlyOne(this.id,this.name)">
                ...
                <div id="div-under" class="mt-2" style="display:none;">
                    ...
                    <div class="row">
                        <div class="col-6 col-md-4">
                            <div class="custom-control custom-radio">
                                <input type="radio" value="0.3" class="custom-control-input" id="rdoUnder1"
                                    name="rdoUnder" checked>
                                <label class="custom-control-label" for="rdoUnder1">0.3</label>
                            </div>
                        </div>
                        <div class="col-6 col-md-4">
                            <div class="custom-control custom-radio">
                                <input type="radio" value="0.5" class="custom-control-input" id="rdoUnder2"
                                    name="rdoUnder">
                        ...
                        <div class="col-6 col-md-4">
                            <div class="custom-control custom-radio">
                                <input type="radio" value="1" class="custom-control-input" id="rdoUnder3"
                                    name="rdoUnder">
                        ...
                        <div class="col-6 col-md-4">
                            <div class="custom-control custom-radio">
                                <input type="radio" value="2" class="custom-control-input" id="rdoUnder4"
                                    name="rdoUnder">
                        ...
                        <div class="col-6 col-md-4">
                            <div class="custom-control custom-radio">
                                <input type="radio" value="3" class="custom-control-input" id="rdoUnder5"
                                    name="rdoUnder">
            ...
            <div id="div-contact" class="mb-3">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="AREA" class="custom-control-input" id="chkContact1"
                                name="chkContact" onchange="checkOnlyOne(this.id,this.name)">
                            <label class="custom-control-label" for="chkContact1">AREA</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="POINT" class="custom-control-input" id="chkContact2"
                                name="chkContact" onchange="checkOnlyOne(this.id,this.name)">
    ...
    <tr>
        <td id="td-rest" valign="top">
            <div class="row">
                <div class="col-md-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="มี Rest" class="custom-control-input" id="rdoHaveRest"
                            name="rdoRest" onchange="checkOnlyOne(this.id,this.name)">
                        <label class="custom-control-label" for="rdoHaveRest">มี Rest</label>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ไม่มี Rest" class="custom-control-input" id="rdoNoRest"
                            name="rdoRest" onchange="checkOnlyOne(this.id,this.name)" checked>
            ...
            <div id="div-haverest" class="mt-3" style="display:none;">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="MESIAL REST" class="custom-control-input chkHaveRest"
                                name="chkHaveRest1" id="chkHaveRest1">
                            <label class="custom-control-label" for="chkHaveRest1">MESIAL REST</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="DISTAL REST" class="custom-control-input chkHaveRest"
                                name="chkHaveRest2" id="chkHaveRest2">
                            <label class="custom-control-label" for="chkHaveRest2">DISTAL REST</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="CINGULUM REST" class="custom-control-input chkHaveRest"
                                name="chkHaveRest3" id="chkHaveRest3">
                            <label class="custom-control-label" for="chkHaveRest3">CINGULUM REST</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="LINGUAL LEDGE" class="custom-control-input chkHaveRest"
                                name="chkHaveRest4" id="chkHaveRest4">
                            <label class="custom-control-label" for="chkHaveRest4">LINGUAL LEDGE</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="EMBRESSURE REST" class="custom-control-input chkHaveRest"
                                name="chkHaveRest5" id="chkHaveRest5">
                ...
                <div id="div-undercut" class="mt-3">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="custom-control custom-radio">
                                <input type="radio" value="มี UNDERCUT" class="custom-control-input"
                                    id="rdoHaveUndercut" name="rdoUndercut" checked>
                                <label class="custom-control-label" for="rdoHaveUndercut">มี</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="custom-control custom-radio">
                                <input type="radio" value="ไม่มี UNDERCUT" class="custom-control-input"
                                    id="rdoNoUndercut" name="rdoUndercut">
                    ...
                    <div id="div-haveundercut" class="mt-2">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-lg-4">
                                <div class="custom-control custom-radio">
                                    <input type="radio" value="UNDERCUT 0.01" class="custom-control-input"
                                        id="rdoHaveUndercut1" name="rdoGroupHaveUndercut" checked>
                                    <label class="custom-control-label" for="rdoHaveUndercut1">0.01</label>
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-4">
                                <div class="custom-control custom-radio">
                                    <input type="radio" value="UNDERCUT 0.02" class="custom-control-input"
                                        id="rdoHaveUndercut2" name="rdoGroupHaveUndercut">
                                    <label class="custom-control-label" for="rdoHaveUndercut2">0.02</label>
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-4">
                                <div class="custom-control custom-radio">
                                    <input type="radio" value="UNDERCUT 0.03" class="custom-control-input"
                                        id="rdoHaveUndercut3" name="rdoGroupHaveUndercut">
        ...
        <td id="td-model" valign="top">
            <div class="row mb-2">
                <div class="col-12">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="SURGICAL GUIDE" class="custom-control-input"
                            id="rdoModelSupergical" name="rdoGroupModel" onchange="checkOnlyOne(this.id,this.name)">
                        <label class="custom-control-label" for="rdoModelSupergical">SURGICAL GUIDE</label>
                    </div>
                </div>
                <div class="col-12">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="MODEL RESIN (PRINT MODEL)" class="custom-control-input"
                            id="rdoModelResin" name="rdoGroupModel" onchange="checkOnlyOne(this.id,this.name)">
                        <label class="custom-control-label" for="rdoModelResin">MODEL RESIN (PRINT MODEL)</label>
                    </div>
                </div>
                <div class="col-12">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="รอถามแพทย์" class="custom-control-input" id="rdoModelDoctor"
                            name="rdoGroupModel" onchange="checkOnlyOne(this.id,this.name)">
                        <label class="custom-control-label" for="rdoModelDoctor">รอถามแพทย์</label>
                    </div>
                    <textarea name="txtDoctorModel" class="form-control hidden" rows="2" cols="66"
                        placeholder="ระบุ"></textarea>
                </div>
                <div class="col-12">
            ...
            <div id="div-model-resin" class="mt-3" style="display:none;">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="custom-control custom-radio">
                            <input type="radio" value="บน" class="custom-control-input" id="rdoModelResin1"
                                name="rdoModelResin" checked>
                            <label class="custom-control-label" for="rdoModelResin1">บน</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="custom-control custom-radio">
                            <input type="radio" value="ล่าง" class="custom-control-input" id="rdoModelResin2"
                                name="rdoModelResin">
                    ...
                    <div class="col-md-6">
                        <div class="custom-control custom-radio">
                            <input type="radio" value="บนและล่าง" class="custom-control-input" id="rdoModelResin3"
                                name="rdoModelResin">
                    ...
                    <div class="col-md-6">
                        <div class="custom-control custom-radio">
                            <input type="radio" value="เต็มปาก" class="custom-control-input" id="rdoModelResin4"
                                name="rdoModelResin">
                    ...
                    <div class="col-md-6">
                        <div class="custom-control custom-radio">
                            <input type="radio" value="ครึ่งปาก" class="custom-control-input" id="rdoModelResin5"
                                name="rdoModelResin">
                    ...
                    <div class="col-md-6">
                        <div class="custom-control custom-radio">
                            <input type="radio" value="1/4" class="custom-control-input" id="rdoModelResin6"
                                name="rdoModelResin">
        ...
        <td id="td-implant" valign="top" rowspan="3">
            <div id="div-system" class="mb-3">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="ระบบ TI-BASE" class="custom-control-input" id="rdoTbase"
                                name="rdoGroupSystem" onchange="checkOnlyOne(this.id,this.name)">
                            <label class="custom-control-label" for="rdoTbase">ระบบ TI-BASE</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="ระบบ TITANIUM CUSTOMED" class="custom-control-input"
                                id="rdoTitanium" name="rdoGroupSystem" onchange="checkOnlyOne(this.id,this.name)">
                            <label class="custom-control-label" for="rdoTitanium">ระบบ TITANIUM CUSTOMED</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="ระบบ STANDARD" class="custom-control-input" id="rdoStandard"
                                name="rdoGroupSystem" onchange="checkOnlyOne(this.id,this.name)">
            ...
            <div id="div-retained" class="mb-3">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="Cement-retained" class="custom-control-input" id="rdoCement"
                                name="rdoGroupRetained" onchange="checkOnlyOne(this.id,this.name)">
                            <label class="custom-control-label" for="rdoCement">Cement-retained</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="Screw-retained" class="custom-control-input" id="rdoScrew"
                                name="rdoGroupRetained" onchange="checkOnlyOne(this.id,this.name)">
            ...
            <div id="div-brand" class="mb-3">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="STRAUMANN" class="custom-control-input" id="rdoBrand1"
                                name="rdoGroupImpBrand" onchange="checkOnlyOne(this.id,this.name)">
                            <label class="custom-control-label" for="rdoBrand1">STRAUMANN</label>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="ASTRA" class="custom-control-input" id="rdoBrand2"
                                name="rdoGroupImpBrand" onchange="checkOnlyOne(this.id,this.name)">
                    ...
                    <div class="col-lg-6">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="OSSTEM" class="custom-control-input" id="rdoBrand3"
                                name="rdoGroupImpBrand" onchange="checkOnlyOne(this.id,this.name)">
                    ...
                    <div class="col-lg-6">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="อื่นๆ" class="custom-control-input" id="rdoBrand4"
                                name="rdoGroupImpBrand" onchange="checkOnlyOne(this.id,this.name)">
                            <label class="custom-control-label" for="rdoBrand4">อื่นๆ</label>
                        </div>
                        <input type="text" name="txtImpBrandOther" class="form-control form-control-sm hidden"
                            placeholder="ระบุ" name="txtImpBrandOther">
                    </div>
                </div>
            </div>
            <div id="div-cement" class="mb-3">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="ให้แลป Fix Cement ด้วย" class="custom-control-input"
                                id="rdoFix" name="rdoFixCement" onchange="checkOnlyOne(this.id,this.name)">
                            <label class="custom-control-label" for="rdoFix">ให้แลป Fix Cement ด้วย</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="แลปไม่ต้อง Fix Cement" class="custom-control-input"
                                id="rdoNotFix" name="rdoFixCement" onchange="checkOnlyOne(this.id,this.name)">
                            <label class="custom-control-label" for="rdoNotFix">แลปไม่ต้อง Fix Cement</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="รอถามแพทย์" class="custom-control-input" id="rdoDoctorFix"
                                name="rdoFixCement" onchange="checkOnlyOne(this.id,this.name)">
                        ...
                        <textarea name="txtDoctorFix" class="form-control hidden" rows="2" cols="66"
                            placeholder="ระบุ"></textarea>
                    </div>
                    <div class="col-12">
    ...
    <tr>
        <td valign="top">
            <div class="row">
                <div class="col-md-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="PINTOOTH" class="custom-control-input" id="rdopintooth"
                            name="rdopintooth" onchange="checkOnlyOne(this.id,this.name)">
                        <label class="custom-control-label" for="rdopintooth">PINTOOTH</label>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="COOPING" class="custom-control-input" id="rdocooping"
                            name="rdopintooth" onchange="checkOnlyOne(this.id,this.name)">
        ...
        <td valign="top">
            <div class="row">
                <div class="col-md-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="มี Rest" class="custom-control-input" id="rdopintoothhookHaveRest"
                            name="rdopintoothhook" onclick="checkOnlyOne(this.id,this.name)">
                        <label class="custom-control-label" for="rdopintoothhookHaveRest">มี Rest</label>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ไม่มี Rest" class="custom-control-input"
                            id="rdopintoothhookNoRest" name="rdopintoothhook" onclick="checkOnlyOne(this.id,this.name)"
                            checked>
            ...
            <div id="div-pintoothhaverest" class="mt-3 hidden">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="MESIAL REST" class="custom-control-input"
                                name="chkHaveRestpintooth" id="chkHaveRestpintooth1"
                                onclick="checkOnlyOne(this.id,this.name)">
                            <label class="custom-control-label" for="chkHaveRestpintooth1">MESIAL REST</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="DISTAL REST" class="custom-control-input"
                                name="chkHaveRestpintooth" id="chkHaveRestpintooth2"
                                onclick="checkOnlyOne(this.id,this.name)">
                    ...
                    <div class="col-12">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="MESIAL/DISTAL REST" class="custom-control-input"
                                name="chkHaveRestpintooth" id="chkHaveRestpintooth3"
                                onclick="checkOnlyOne(this.id,this.name)">
        ...
        <td valign="top">
            <div class="row">
                <div class="col-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="NON PRECIOUS" class="custom-control-input"
                            name="chkpintoothalloys" id="chkpintoothalloys1" onclick="checkOnlyOne(this.id,this.name)">
                        <label class="custom-control-label" for="chkpintoothalloys1">NON PRECIOUS</label>
                    </div>
                </div>
                <div class="col-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="PALLADIUM" class="custom-control-input" name="chkpintoothalloys"
                            id="chkpintoothalloys2" onclick="checkOnlyOne(this.id,this.name)">
                        <label class="custom-control-label" for="chkpintoothalloys2">PALLADIUM</label>
                    </div>
                </div>
                <div class="col-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="SEMI PRECIOUS" class="custom-control-input"
                            name="chkpintoothalloys" id="chkpintoothalloys3" onclick="checkOnlyOne(this.id,this.name)">
                        <label class="custom-control-label" for="chkpintoothalloys3">SEMI PRECIOUS</label>
                    </div>
                </div>
                <div class="col-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="HIGH PRECIOUS" class="custom-control-input"
                            name="chkpintoothalloys" id="chkpintoothalloys4" onclick="checkOnlyOne(this.id,this.name)">
                        <label class="custom-control-label" for="chkpintoothalloys4">HIGH PRECIOUS</label>
                    </div>
                </div>
                <div class="col-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="ZIRCONIA" class="custom-control-input" name="chkpintoothalloys"
                            id="chkpintoothalloys5" onclick="checkOnlyOne(this.id,this.name)">
                        <label class="custom-control-label" for="chkpintoothalloys5">ZIRCONIA</label>
                    </div>
                </div>
                <div class="col-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="CERAMAGE" class="custom-control-input" name="chkpintoothalloys"
                            id="chkpintoothalloys6" onclick="checkOnlyOne(this.id,this.name)">
                        <label class="custom-control-label" for="chkpintoothalloys6">CERAMAGE</label>
                    </div>
                </div>
                <div class="col-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="COMPOSITE" class="custom-control-input" name="chkpintoothalloys"
                            id="chkpintoothalloys7" onclick="checkOnlyOne(this.id,this.name)">
                        <label class="custom-control-label" for="chkpintoothalloys7">COMPOSITE</label>
                    </div>
                </div>
                <div class="col-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" value="รอถามแพทย์" class="custom-control-input" name="chkpintoothalloys"
                            id="chkpintoothalloys8" onclick="checkOnlyOne(this.id,this.name)">
                        <label class="custom-control-label" for="chkpintoothalloys8">รอถามแพทย์</label>
                    </div>
                </div>
                <div class="col-12" id="Notepintoothalloys">
                    <textarea name="Notepintoothalloys" class="form-control" rows="2" cols="66"
                        placeholder="หมายเหตุ"></textarea>
                </div>
                <div class="col-12 hidden" id="Commentpintoothalloys">
                    <textarea name="Commentpintoothalloys" class="form-control" rows="2" cols="66"
                        placeholder="ระบุ"></textarea>
                </div>
            </div>
        </td>
...
<div class="col-12 px-0 mt-2 text-right">
    <input type="button" class="btn btn-lg btn-info" onclick="checking_screen()" data-toggle="modal"
        data-target="#checking_screen" value="ตรวจสอบการ screen ซี่ฟัน" />
    @if( $count != 0)
...
{{-- ตรวจสอบการ screen --}}
<div class="modal fade show" id="checking_screen" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="false">
