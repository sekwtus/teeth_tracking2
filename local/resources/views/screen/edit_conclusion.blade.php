...
<div class="container-fluid">
  {{ Form::open(['method'=>'post' , 'url'=>'/mainscreen/edit_conclusion/'.$id.'/'. $group .'/save']) }}
  @php
      $count = 0;
  @endphp
        ...
        <tr>
          ...
          <td id="td-conclusion-tooth" valign="top" rowspan="5">
            ...
            <div class="text-right">
              <button class="btn btn-success" type="menu" formaction="{{ url('/edit_conclusion/edit_teeth/'.$id) }}">บันทึกการแก้ไข</button>
            </div>
          </td>
          {{ Form::close() }}
        </tr>
