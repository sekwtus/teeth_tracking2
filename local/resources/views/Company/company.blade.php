                ...
                <div class="card-body">
                    ...
                    <div class="modal fade" id="DELETE{{ $out_data_company->ID }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myModalLabel">Delete Lab</h5>
                                    <button type="button" class="btn btn-icons btn-rounded btn-closed" title="close" data-dismiss="modal"><i class="mdi mdi-close"></i></button>
                                </div>
                                <div class="modal-body">
                                    <h5>confirm Delete : {{ $out_data_company->Name }}</h5>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return '<button class="btn btn-warning" data-toggle="modal" data-target="#EDIT'+data+'" style="padding:5px;">&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;</button>\
                            @if (Auth::user()->ID_type_users == 1)\
                                <button class="btn btn-danger" data-toggle="modal" data-target="#DELETE'+data+'" style="padding:5px;">Delete</button>\
                            @endif'
                        }
                }],
                "order": []
