                    ...
                    <div class="row mt-3">
                        <div class="col-md-3 m-0 step-timeline">
                            <ul class="m-0 step-list">
                                <li>Product Type</li>
                                <li>Department</li>
                                <li class="yellow">Sub-Department</li>
                                    ...
                                    <div class="card-header" role="tab" id="orderRequestTypeID">
                                        <h6 class="mb-0">
                                            <a data-toggle="collapse" href="#MetalType" aria-expanded="true" aria-controls="MetalType">
                                                <i class="card-icon mdi mdi-checkbox-marked-circle-outline"></i>Sub Department
                                            </a>
                                        </h6>
                                    </div>
                                        ...
                                        <div class="card-body text-center">
                                            <div class="radio-toolbar text-center justify-content-center" style="max-height: 400px;overflow-x:hidden;overflow-y: scroll;">
                                                @php
                                                    $count = 1;
                                                @endphp
                                                @foreach($data_sub_department as $out_data_sub_department)
                                                <div class="{{$count}}">
                                                    <div class="row Department_{{$out_data_sub_department->Name}}  P{{$count}}" id="P{{$count}}" onclick="test('P{{$count}}')">
                                                        <input type="radio" id="{{$out_data_sub_department->Name}}" name="type_department" value="{{$out_data_sub_department->ID}}" >
                                                        <label for="{{$out_data_sub_department->Name}}" style="cursor:pointer;">{{$out_data_sub_department->Name}}</label>
                                                    </div>
                                                </div>
                                                @php
                                                    $count++;
