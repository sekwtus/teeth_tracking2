        ...
        <div class="row mt-3">
            <div class="col-md-3 m-0 step-timeline">
              <ul class="m-0 step-list">
                <li class="yellow">ชื่อบริษัท</li>
                <li class="white">สาขาย่อย</li>
                            ...
                            <div class="col-lg-12">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                                                <li class="breadcrumb-item active" aria-current="page">เลือกบริษัท</li>
                                        </ol>
                                    </nav>
                                        ...
                                        <div class="card-body text-center">
                                           <div class="checkbox-toolbar">
                                                @foreach($data_company as $out_data_company)
                                                    <a href = "{{ url('company_master1/').'/'.$out_data_company->ID }}" >
                                                        <button type="button" class="button1">
                                                        {{ $out_data_company->fullname}}<br>({{ $out_data_company->Name}})
                                                        </button>
                                                    </a>
                                                @endforeach
                                                <br>
