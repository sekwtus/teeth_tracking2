                            ...
                            <div class="col-lg-12">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                                                <li class="breadcrumb-item active" aria-current="page">ฝ่าย</li>
                                        </ol>
                                    </nav>
                                    ...
                                    <div class="collapse show" >
                                        <div class="card-body text-center">
                                           <div class="checkbox-toolbar">
                                                @foreach($data_division as $data_division)
                                                    <a href = "{{ url('company_master3/').'/'.$data_division->ID }}" >
