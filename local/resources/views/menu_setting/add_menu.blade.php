...
{{ Form::open(['method' => 'post' , 'url' => '/add_menu/add' , 'id' => 'regForm']) }}
                                    ...
                                    <div class="radio-toolbar text-center justify-content-center">
                                        <div class="row" style="over-flow:auto;">
                                         <div class="col-lg-6">
                                            ...
                                            <label for="nochkPassport"  style="cursor:pointer; width:60%; height:20%;"><h2>Menu หลัก </h2></label>
                                         </div>
                                         <div class="col-lg-6">
                                            <input type="radio" name="Hook"  id="chkPassport" value="have" onclick="HookFunction()" >
                                            <label for="chkPassport"  style="cursor:pointer; width:60%; height:20%;"><h2>Menu ย่อย </h2> </label>
                                         </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <div class="row" >
                                                                <div class="col-lg-12">
                                                                    <select class="form-control" name="parent_menu">
                                                                        <option value=""> เลือก Parent Menu</option>

                                                                        @foreach($data_menu as $out_data_menu)
                                                                            @if(($out_data_menu->menu_parent / 100) == 0)
                                                                        <option value="{{ $out_data_menu->menu_code }}">{{ $out_data_menu->menu_name }}</option>
                                                                            @endif
                                                                        @endforeach
    ...
    <div class="tab">ตั้งชื่อ Menu:
      <p><input placeholder="example menu..." oninput="this.className = ''" name="menuname"></p>
      <br> ตั้งชื่อ path Menu:
      <p><input placeholder="/example/path" oninput="this.className = ''" name="path"></p>
    </div>
    <div class="tab">
        <h2>เลือก Icon</h2>
        <pre><code>&lt;i class=&quot;mdi mdi-<span id="name">name</span>&quot;&gt;&lt;/i&gt;</code></pre><br>
        <div class="icons" id="icons" onclick="getName()"></div>
...
<script type="text/javascript">
    ...
    function getName(){
        document.getElementById('icon').value = $("#name").text();
    }
    (function () {
