    ...
    <div class="col-12 grid-margin">
      <div class="card">
        <div class="card-body">
          ...
          {{ Form::open(['method' => 'post' , 'url' => '/order4/addteeth']) }}
          <div class="row mt-3">
                                ...
                                <div class="col-lg-6">
                                    <table class="tbl-tooth">
                                        ...
                                        <tr>
                                            <td></td>
                                            <td class="text-center">
                                                <label class="lbl lbl_green_13" id="lbl_green_13" style="margin-right:-80px;margin-top:-10px;">
                                                    <img src="./images/tooth3color/13.png" class="img-tooth img-tooth-13" id="img-tooth-13" onclick="check(13)">
                                                </label>
                                            </td>
                                            <td></td>
                                            <td></td>
                                            ...
                                            <td></td>
                                            <td class="text-center">
                                                <label class="lbl lbl_green_23" id="lbl_green_23" style="margin-left:-80px;margin-top:-10px;">
                                        ...
                                        <tr>
                                            <td></td>
                                            <td class="text-center">
                                                <label class="lbl lbl_green_14" id="lbl_green_14" style="margin-right:-50px; margin-top:-10px;">
                                            ...
                                            <td></td>
                                            <td class="text-center">
                                                <label class="lbl lbl_green_24" id="lbl_green_24" style="margin-left:-50px; margin-top:-10px;">
            ...
            <div class="card-body">
                <table class="table table-striped table-bordered">
                    ...
                    @endphp
                    @foreach($teeth as $out_teeth)
                    {{ Form::open(['method' => 'post' , 'url' => '/order4/'.$out_teeth->ID.'/delete']) }}
                    <tbody>
                        <tr>
