            ...
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col-10">
                            <ul class="nav nav-tabs tab-basic" role="tablist">
                                <!--<li class="nav-item">
                                    <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#complete" role="tab" aria-controls="whoweare" aria-selected="true">
                                        <h6>รายการผลิต</h6>
                                    </a>
                                </li>
                                 {{-- <li class="nav-item">
                ...
                <div class="card-body">
                    <div class="tab-content tab-content-basic">
                        <div class="tab-pane " id="product" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="tab-pane active in" id="complete" role="tabpanel" aria-labelledby="profile-tab">
