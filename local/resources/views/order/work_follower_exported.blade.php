            ...
            <div class="card">
                ...
                <div class="row border-bottom">
                    ...
                    <div class="tab-content tab-content-basic">
                        ...
                        {{-- <div class="row">
                                <div class="col-lg-2"><input type="text" class="form-control" name="bracode" id="bracode"style="padding: 0px; height: 30px;" value='{{ ($_GET['bracode']) ? ($_GET["bracode"]) : ('')}}' /></div>
                            <div class="col-lg-2"><input type="text" class="form-control" name="search_customer" id="search_customer"style="padding: 0px; height: 30px;" value='{{ ($_GET['search_customer']) ? ($_GET["search_customer"]) : ('')}}' /></div>
                            <div class="col-lg-2"><input type="text" class="form-control" name="dentist" id="dentist"style="padding: 0px; height: 30px;" value='{{ (($_GET["dentist"])) ? ($_GET["dentist"]) : ('')}}' /></div>
                            <div class="col-lg-2"><input type="text" class="form-control" name="search_zone" id="search_zone"style="padding: 0px; height: 30px;" value='{{ ($_GET['search_zone']) ? ($_GET["search_zone"]) : ('')}}' /></div>
                            <div class="col-lg-2"><input type="text" class="form-control" name="search_area" id="search_area"style="padding: 0px; height: 30px;" value='{{ ($_GET['search_area']) ? ($_GET["search_area"]) : ('')}}'/></div>
                            <div class="col-lg-2"><input type="text" class="form-control" name="search_work_type" id="search_work_type"style="padding: 0px; height: 30px;" value='{{ ($_GET['search_work_type']) ? ($_GET["search_work_type"]) : ('')}}'/></div>
                            <div class="col-lg-2"><input type="text" class="form-control" name="search_depart" id="search_depart"style="padding: 0px; height: 30px;" value='{{ ($_GET['search_depart']) ? ($_GET["search_depart"]) : ('')}}'/></div>
                            <div class="col-lg-2"><h6>ค้นหาสถานะงาน : </h6></div>
                        </div> --}}
                        <div class="row">
                                {{-- <div class="col-lg-2"><input type="text" class="form-control" name="search_depart" id="search_depart"style="padding: 0px; height: 30px;" value='{{ ($_GET['search_depart']) ? ($_GET["search_depart"]) : ('')}}'/></div> --}}
...
<script>
    ...
    var area = 'ทั้งหมด'
        ...
        var table =  $('#table2').DataTable({
            ...
            processing: true,
            // serverSide: true,/////
           // ajax: '{{ url('/table/work_follower/orderComplete') }}',
           ajax: {
                    url : "{{ url('/table/work_follower/orderComplete') }}",
                    // type : 'GET',
                    data : function (d) {
                            ...
                            d.search_depart = $('#search_depart').val();
