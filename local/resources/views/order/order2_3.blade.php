...
<div class="content-wrapper">
    <div class="row" id="stepApp">
        <div class="col-12 grid-margin">
            <div class="card">
                {{ Form::open(['method' => 'post' , 'url' => '/order2/addDoctorID']) }}
                <div class="card-body">
                    <div class="row border-bottom">
                        ...
                        <div class="col-2 p-0 text-left">
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#ADD">+ เพิ่มหมอ</button>
                        </div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                                            ...
                                            <li class="breadcrumb-item"><a
                                                    href="#">{{ $out_data_customer->customer_type }}</a></li>
                                            <li class="breadcrumb-item"><a
                                                    href="#">{{ $out_data_customer->customer }}</a></li>
                                            @endforeach
                                            <li class="breadcrumb-item active" aria-current="page">เลือกทันตแพทย์</li>
                                        </ol>
                                    </nav>
                                    <div class="accordion basic-accordion" role="tablist">
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="collapse show" role="tabpanel"
                                                aria-labelledby="orderRequestTypeID">
                                                ...
                                                <div class="col-lg-5" align="center">
                                                    <input type="text" id="myInput" onkeyup="myFunction()" placeholder="ค้นหาทันตแพทย์" title="Type in a name">
                                                </div>
                                            </div> -->
                                                    @foreach($doctor_all as $out_doctor_all)
                                                    <a href="#">
                                                        <button name="radio" type="submit" class="button1" name="radio"
                                                            value="{{ $out_doctor_all->ID }}">
                                                            {{ $out_doctor_all->Name }}
                                                        </button>
                                                    </a>
                                                    @endforeach
...
{{ Form::open(['method' => 'post' , 'url' => '/order2_3/addDoctor']) }}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    {{ Form::text('Name_Doctor',null, ['class' => 'form-control','placeholder' => 'ชื่อ-นามสกุล']) }}
                    {{ Form::hidden('customer',$out_data_customer->customer, ['class' => 'form-control']) }}
                    ...
                    <label>Line :</label>
                    {{ Form::text('line',null, ['class' => 'form-control','placeholder' => 'ที่อยู่']) }}
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">ยกเลิก</button>
                    <button type="submit" class="btn btn-success" id="add" name="add" value="save">ยืนยัน</button>
                </div>
            </div>
        </div>
    </div>
