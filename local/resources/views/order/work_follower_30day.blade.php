            ...
            <div class="card">
                ...
                <div class="row border-bottom">
                    <div class="col-12 p-0 text-left">
                        <h4>งานที่จัดส่งแล้ว ไม่เกิน30วัน </h4>
                    </div>
                </div>
                <br>
...
<script>
    ...
    var area = 'ทั้งหมด'
        ...
        //   serverSide: true,
          sortable: true,
          searchable: true,
          ajax: '{{ url('/table/work_follower/order_30day') }}',
          columns: [
                //    { data: 'ID', name: 'ID' },
                ...
                },
                {
                    'max-width': '5px',  "targets": 20 , render: function(data,type,row){
                        if (row['job_current_department'] == null || row['job_current_department'] == '') {
                            ...
                            if(row['job_current_department'] == 1000){
                                ...
                                if (row['job_current_sub_department'] && row['job_current_department']) {
