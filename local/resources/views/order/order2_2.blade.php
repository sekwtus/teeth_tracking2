                                ...
                                <div class="col-lg-12">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                                            ...
                                            @endforeach
                                            <li class="breadcrumb-item active" aria-current="page">เลือกลูกค้า</li>
                                        </ol>
                                    </nav>
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="orderRequestTypeID">
                                                <div id="myUL" class="card-body">
                                                    ...
                                                    <br>
                                                    @foreach($customer_all as $out_customer_all)
                                                    <a href="#">
                                                        <button name="radio" type="submit" class="button1" name="radio" value="{{ $out_customer_all->ID }}">
                                                            {{ $out_customer_all->Name }}
                                                        </button>
                                                    </a>
                                                    @endforeach
                                                </div>
