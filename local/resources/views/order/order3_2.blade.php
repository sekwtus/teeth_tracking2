    ...
    <div class="col-12 grid-margin">
      <div class="card">
        ...
        <div class="card-body">
          ...
          {{ Form::open(['method' => 'post' , 'url' => '/order3_2/addBranchID']) }}
          <div class="row mt-3">
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                                            @foreach($data_company as $out_data_company)
                                                <li class="breadcrumb-item"><a href="#">{{ $out_data_company->fullname }}</a></li>
                                            @endforeach
                                                <li class="breadcrumb-item active" aria-current="page">เลือกสาขาที่ส่งงาน</li>
                                        </ol>
                                        {{-- <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                                                <li class="breadcrumb-item active" aria-current="page">เลือกสาขาที่ส่งงาน</li>
                                        </ol> --}}
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        @foreach($type_Branch as $out_type_Branch)
                                            <button name="radio" type="submit" class="button1" name="radio" value="{{ $out_type_Branch->ID }}">
                                                    {{ $out_type_Branch->Name }}
                                            </button>
                                        @endforeach
                                    </div>
                                    </div>
